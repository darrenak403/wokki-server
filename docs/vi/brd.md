...
| FR-105 | P1 | Nhân viên cần Active `LocationMembership` để vào route workspace được bảo vệ; chưa có membership thì gửi yêu cầu ở `/join` và chờ Admin/Manager chi nhánh mục tiêu duyệt. |
