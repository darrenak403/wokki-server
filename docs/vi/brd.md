...
| FR-105 | P1 | Org Admin tạo nhân viên kèm `DepartmentId`; hệ thống tự tạo Active `LocationMembership` tại chi nhánh phòng ban. Nhân viên đăng nhập trực tiếp — không có luồng `/join` hay duyệt yêu cầu. |
