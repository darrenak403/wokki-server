...
using Wokki.Application.Services.OrgJoinRequest.Implementations;
...
using Wokki.Application.Services.SwapPost.Implementations;
...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<ISwapPostService, SwapPostService>();
