...
namespace Wokki.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260529181633_AddUserMustChangePasswordAndAuthOtp")]
    partial class AddUserMustChangePasswordAndAuthOtp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wokki.Domain.Entities.AuthOtpChallenge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Email", "ConsumedAtUtc", "ExpiresAtUtc");

                    b.ToTable("auth_otp_challenges", (string)null);
                });

            modelBuilder.Entity("Wokki.Domain.Entities.AuthOtpSendLimit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("auth_otp_send_limits", (string)null);
                });
