...
namespace Wokki.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260629153623_AddAttendanceCheckInVerificationFields")]
    partial class AddAttendanceCheckInVerificationFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wokki.Domain.Entities.AttendanceRecord", b =>
                {
                    ...
                    b.Property<string>("ClockInPhotoPublicId")
                        .HasMaxLength(300)
                    ...
                    b.Property<DateTime?>("EligibleMarkedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid?>("EligibleMarkedBy")
                        .HasColumnType("uuid");

                    b.Property<Guid>("EmployeeId")
                        .HasColumnType("uuid");

                    b.Property<bool?>("FaceMismatch")
                        .HasColumnType("boolean");

                    b.Property<bool?>("GpsOutOfRange")
                        .HasColumnType("boolean");

                    b.Property<bool?>("IpMismatch")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("PayrollEligible")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Wokki.Domain.Entities.Employee", b =>
                {
                    ...
                    b.Property<string>("FaceEnrollmentPhotoPublicId")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)");

                    b.Property<string>("FaceEnrollmentPhotoUrl")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("Wokki.Domain.Entities.Location", b =>
                {
                    ...
                    b.Property<string>("NetworkIpOrCidr")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("Wokki.Domain.Entities.OrgJoinRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("org_join_requests", (string)null);
                });
            ...
            modelBuilder.Entity("Wokki.Domain.Entities.OrganizationSchedulingPolicy", b =>
                {
                    b.Property<Guid>("OrganizationId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Wokki.Domain.Entities.Schedule", b =>
                {
                    ...
                    b.Property<DateTime?>("SuggestionsAppliedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Wokki.Domain.Entities.ScheduleLeaveRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ScheduleId", "EmployeeId", "ShiftDefinitionId", "Date")
                        .IsUnique()
                        .HasDatabaseName("IX_schedule_leave_requests_pending_slot_unique")
                        .HasFilter("\"Status\" = 0");

                    b.ToTable("schedule_leave_requests", (string)null);
                });
            ...
            modelBuilder.Entity("Wokki.Domain.Entities.OrgJoinRequest", b =>
                {
                    b.HasOne("Wokki.Domain.Entities.Organization", "Organization")
                        .WithMany()
                        .HasForeignKey("OrganizationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Wokki.Domain.Entities.OrganizationSchedulingPolicy", b =>
                {
                    b.HasOne("Wokki.Domain.Entities.Organization", null)
                        .WithOne()
                        .HasForeignKey("Wokki.Domain.Entities.OrganizationSchedulingPolicy", "OrganizationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
